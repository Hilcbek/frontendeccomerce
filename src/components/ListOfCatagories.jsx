  ...
  return (
    <div className='w-[95%] mx-auto flex items-start justify-start flex-col'>
        <div className='w-full mx-auto flex items-start justify-start flex-col'>
         <h1 className='text3 my-3'>Related products of `{<span className='underline text italic text-red-600'>{location}</span>}`</h1>
        <div className='w-full flex xs:items-start xs:flex-col lg:flex-row lg:items-center xs:justify-start lg:justify-between'>
            <div className='flex xs:items-start xs:w-full lg:w-fit xs:flex-col lg:flex-row lg:items-center xs:justify-start lg:justify-between'>
                ...
                <select onChange={handleClick} name="color" id="" className='p-3 xs:my-2 lg:my-0 xs:w-11/12  border-solid border-black/60 border-[1px] text-md font-light cursor-pointer mx-3 bg-transparent lg:w-32 flex items-center justify-center text-center'>
                ...
                <select onChange={handleClick} name="size" id="" className='p-3 xs:my-2 lg:my-0 xs:w-11/12 border-solid border-black/60 border-[1px] text-md font-light cursor-pointer mx-3 bg-transparent lg:w-32 flex items-center justify-center text-center'>
